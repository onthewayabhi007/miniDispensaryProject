...
})({"ec5ou":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "ba8b505f75320ab4";
"use strict";
...
},{}],"39R86":[function(require,module,exports) {
...
const login = async (id, password)=>{
    ...
    const response = await instance.post("signin/", data, config).then((response)=>{
        console.log(response.data);
        if (response.data != null) redirectToPage(response.data);
...
},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["ec5ou","39R86"], "39R86", "parcelRequire09f5")

//# sourceMappingURL=Login_med_staff.75320ab4.js.map
